...
export function Dashboard({ onLogout }: DashboardProps) {
  ...
  const [ssoImportDialogOpen, setSsoImportDialogOpen] = useState(false)
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              <Button onClick={() => setSsoImportDialogOpen(true)} size="sm" variant="outline">
      ...
      {/* AWS SSO 自动导入对话框 */}
      <SsoImportDialog
        open={ssoImportDialogOpen}
        onOpenChange={setSsoImportDialogOpen}
      />
